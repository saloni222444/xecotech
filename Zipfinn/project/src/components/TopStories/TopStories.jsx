...
const TopStories = () => {
  ...
  const renderLogo = (logo, index) => {
    if (logo.startsWith('http')) {
      return (
        <img
          key={index}
          className="logo-PsAlMQQF xxxsmall-PsAlMQQF letter-PsAlMQQF"
          src={logo}
          alt=""
          loading="lazy"
        />
      ...
      return (
        <span key={index} className="logo-PsAlMQQF xxxsmall-PsAlMQQF letter-PsAlMQQF">
          {logo}
        </span>
      );
    }
  ...
  return (
    <div
      ...
      className="container-oFtCtY_t"
    >
      <div className="header-oFtCtY_t header-m-oFtCtY_t">
        <div className="wrapper-HeCy_Rm7 wrap-HeCy_Rm7">
          <span className="titleAndHintWrapper-HeCy_Rm7 truncated-HeCy_Rm7">
            <div className="container-HeCy_Rm7">
              {/* ✅ FIXED: Nested <a> tag removed */}
              <a className="containerLink-HeCy_Rm7" href="/news/top-stories/all/">
                <h3 className="title-HeCy_Rm7 title-m-HeCy_Rm7" id="top-stories">
                  Top stories﻿
      ...
      <div className="content-oFtCtY_t">
        <div>
          <div className="grid-iTt_Zp4a">
            {stories.map(story => (
              <a
                key={story.id}
                href={`/news/tradingview:${story.id}-${story.title.toLowerCase().replace(/[^a-z0-9]/g, '-')}/`}
                target="_blank"
                className="card-DmjQR0Aa card-h0q8oyW8"
              >
                <article className="article-DmjQR0Aa wrapper-DmjQR0Aa" data-qa-id="news-headline-card">
                  <div className="container-DmjQR0Aa">
                    <div className="header-DmjQR0Aa header-TUPxzdRV">
                      <ul className="stack-L2E26Swf stack--xxxsmall-L2E26Swf logo-TUPxzdRV apply-common-tooltip">
                      ...
                      <span className="date-TUPxzdRV doth-TUPxzdRV">
                    ...
                    <div
                      className="apply-overflow-tooltip apply-overflow-tooltip--direction_both block-bETdSLzM title-DmjQR0Aa"
      ...
      <div className="footer-oFtCtY_t">
        <div data-id="more-button">
          <a
            href="/news/top-stories/all/"
            className="button-hLc5LYm1 textButton-H6_2ZGVv link-H6_2ZGVv brand-H6_2ZGVv medium-H6_2ZGVv"
          >
            <span className="background-H6_2ZGVv"></span>
            <span className="content-H6_2ZGVv">
              <span className="title-hLc5LYm1">
                Keep <span className="noBreak-HkGXK524">reading
