...
import FutureNews from "./FutureNews";
import './Future.css';
            ...
            <div className="logo-text-wrapper">
              ...
              <div className="title-wrapper">
                <a href="/markets/stocks-usa/" className="title-link">
                  <h2 className="section-title">Futures and commodities﻿</h2>
                </a>
              </div>
            </div>
          </div>
              ...
              <div className="widget-card">
                <div className="widget-header">
                  <a href="/markets/stocks-usa/market-movers-gainers/" className="title-link">
                    <h3 className="widget-title">Energy futures﻿</h3>
                  </a>
                </div>
              ...
              <div className="widget-card">
                <div className="widget-header">
                  <a href="/markets/stocks-usa/market-movers-losers/" className="title-link">
                    <h3 className="widget-title">Metals futures﻿</h3>
                  </a>
                </div>
                {/* <div className="tabs-container">
                  <div className="tabs">
