    ...
    sections: [
      {
        ...
        children: [
          ...
          {
            id: 2,
            title: "Most Popular Broker 2021",
            broker: "OANDA",
          ...
          {
            id: 4,
            title: "Most Innovative Tech 2021",
            broker: "Dhan",
          ...
          {
            id: 5,
            title: "Best Multi-Asset Broker 2021",
            broker: "TradeStation",
          ...
          {
            id: 7,
            title: "Best Futures Broker 2021",
          ...
          {
            id: 8,
            title: "Best Crypto Broker or Exchange 2021",
            broker: "BingX",
...
const BrokerAwards2021 = () => {
  ...
  const AwardCard = ({ award }) => (
    <a 
      className={`CO-card ${award.cardClass} CO-theme-winners_2023`}
      href={award.link}
      target="_blank"
      rel="noopener noreferrer"
    >
      {/* New Animated Blob Background */}
      <div className="CO-bg"></div>
      <div className="CO-blob"></div>
      
      {/* Card Content */}
      <div className="CO-card-wrapper">
        <img 
          className="CO-custom-logo" 
          src={ZepfinnLogo} 
          alt="Zepfinn Logo"
        />
        <h2 className="CO-card-title">{award.title}</h2>
        <div className="CO-about-wrap">
          <img className="CO-card-logo" src={award.logo} alt={award.broker} />
          <div className="CO-broker-info">
            <h3 className="CO-broker-name">{award.broker}</h3>
            <span className="CO-broker-description">{award.description}</span>
          </div>
        </div>
      </div>
    </a>
  ...
  return (
    <div className="CO-broker-awards-container">
      <DefaultBrokerAwards />

      {/* Awards Sections */}
      <div className="CO-card-block">
        <div className="CO-sections-container">
          {currentData?.sections?.map((section, index) => (
            <div key={index} className="CO-section-group">
              <span className="CO-section-title">{section.title}</span>
              <div className="CO-sections-block">
      ...
      {/* Who's Next Section */}
      <div className="CO-gradient-wrapper">
        <div className="CO-content-wrapper">
          <div className="CO-cta-content">
            <h2 className="CO-cta-title">Who's next?</h2>
            <p className="CO-cta-text">
              Help your favorite win in 2025 by going to our Top Brokers page, finding your broker, and leaving a review.
            </p>
          </div>
          <a href="/brokers/" className="CO-round-button CO-black CO-primary">
            <span className="CO-button-content">Review brokers</span>
          </a>
        </div>
      </div>

      {/* Share Buttons */}
      <div className="CO-share-container">
        <div className="CO-share-buttons">
          <a
            href="https://www.facebook.com/sharer/sharer.php?u=https://www.tradingview.com/broker-awards/"
            target="_blank"
            rel="nofollow noopener noreferrer"
            className="CO-social-button"
          ...
          <button
            className={`CO-social-button ${copied ? 'CO-copied' : ''}`}
...
export default BrokerAwards2021;