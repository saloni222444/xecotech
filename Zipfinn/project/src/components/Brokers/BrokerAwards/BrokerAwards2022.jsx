    ...
    sections: [
      {
        ...
        children: [
          ...
          {
            id: 2,
            title: "Most Popular Broker 2022",
            broker: "OANDA",
          ...
          {
            id: 4,
            title: "Most Innovative Tech 2022",
            broker: "Dhan",
          ...
          {
            id: 5,
            title: "Best Multi-Asset Broker 2022",
            broker: "TradeStation",
          ...
          {
            id: 7,
            title: "Best Futures Broker 2022",
          ...
          {
            id: 8,
            title: "Best Crypto Broker or Exchange 2022",
            broker: "BingX",
...
const BrokerAwards2022 = () => {
  ...
  const AwardCard = ({ award }) => (
    <a 
      className={`BO-card ${award.cardClass} BO-theme-winners_2023`}
      href={award.link}
      target="_blank"
    ...
    >
      <div className="BO-card-wrapper">
        <img 
          className="BO-custom-logo" 
          src={ZepfinnLogo} 
          alt="Zepfinn Logo"
        />
        <h2 className="BO-card-title">{award.title}</h2>
        <div className="BO-about-wrap">
          <img className="BO-card-logo" src={award.logo} alt={award.broker} />
          <div className="BO-broker-info">
            <h3 className="BO-broker-name">{award.broker}</h3>
            <span className="BO-broker-description">{award.description}</span>
          </div>
        </div>
      </div>
    </a>
  ...
  return (
    <div className="BO-broker-awards-container">
      <DefaultBrokerAwards />

      {/* Awards Sections */}
      <div className="BO-card-block">
        <div className="BO-sections-container">
          {currentData?.sections?.map((section, index) => (
            <div key={index} className="BO-section-group">
              <span className="BO-section-title">{section.title}</span>
              <div className="BO-sections-block">
...
export default BrokerAwards2022;