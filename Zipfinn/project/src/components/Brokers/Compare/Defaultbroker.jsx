...
const CompareBrokers = ({
  ...
  useEffect(() => {
    ...
    switch (path) {
      case '/brokers/AllBrokers':
        setActiveTab('AllBrokers');
        break;
      case '/brokers/stocks':
        setActiveTab('Stocks');
        break;
  ...
  // CompareBrokers.jsx - handleTabClick function update karein
  const handleTabClick = (tab) => {
    const routeMap = {
      'All brokers': '/brokers/all-brokers',
